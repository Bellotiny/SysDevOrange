...
const PHONE_NUMBER = "Numéro de Téléphone";
const CONFIRM_PASSWORD = "Confirmez le Mot de Passe";

// Register Requirements
const PASS_MUST_CONTAIN = "Le mot de passe doit contenir";
const UPPERCASE = "majuscule";
const LOWERCASE = "minuscule";
const NUMBER = "numéro";
const SYMBOL = "symbole";
const MIN_SIX_CHAR = "Minimum de 6 caractères";
