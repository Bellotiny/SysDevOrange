...
const NAILS_ARE_NOT_TOOLS = "Don’t Use Nails as Tools:";
const NAILS_ARE_NOT_TOOLS_2 = "Avoid using nails for opening packages.";
const DONT_IGNORE_ISSUES = "Don’t Ignore Issues:";
const DONT_IGNORE_ISSUES_2 = "Consult a professional for nail problems.";
const AVOID_HARSH_PRODUCTS = "Avoid Harsh Products:";
const AVOID_HARSH_PRODUCTS_2 = "Limit the use of acetone removers.";
const DONT_OVER_POLISH = "Don’t Overdo Polish:";
const DONT_OVER_POLISH_2 = "Too many layers can weaken nails.";
