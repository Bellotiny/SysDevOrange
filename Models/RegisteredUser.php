...
// TODO DELETE THIS CLASS, ONLY USE USER
...
//        $sql = "SELECT email
//                FROM users
//                WHERE email LIKE '" . $data['email'] . "' AND password LIKE SHA1('" . $data['password'] . "') LIMIT 1";
//
//        $result = Model::establishDatabaseConnection()->query($sql);
//
