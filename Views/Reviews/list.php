  ...
  <form method="POST" class="mt-3 mb-3">
    <div class="d-flex flex-column flex-sm-row">
        <div class="flex-grow-1 mb-2 mb-sm-0 me-2">
            ...
            <input type="text" name="search" class="form-control" id="searchInput" placeholder="<?= SEARCH_FOR_REVIEWS ?>" value="<?= $data["search"] ?? "" ?>">
        </div>
...
<div class="col-lg-6 col-xxl-4 my-5 mx-auto">
    <div class="d-grid gap-2">
        <a href="<?=BASE_PATH?>/reviews/add" class="btn bttn-green slide-up" type="button" id="toggleReviewFormButton" aria-expanded="false">
