...
<?php include_once 'Views/bookingModal.php'; ?>
  ...
  <div class="green-background text-secondary  container slide-up ">
    ...
    <form method="POST">
        <label><?= SEARCH ?> <input type="text" name="search" class="form-control" placeholder="<?= SEARCH_FOR_REVIEWS ?>" value="<?= $data["search"] ?? "" ?>"></label>
        <br>
        <input type="submit" value="<?= SEARCH ?>">
    </form>
  <div class="col-lg-6 col-xxl-4 my-5 mx-auto">
  <div class="d-grid gap-2">
    <a href="<?=BASE_PATH?>/reviews/add" class="btn bttn-green slide-up " type="button" id="toggleReviewFormButton" aria-expanded="false" ><?= WRITE_REVIEW ?></a>
  </div>
  </div>
            ...
            <div class="d-flex align-items-center py-2">
                ...
                <div class="w-100 ">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <?php if ($this->user): ?>
                        <div>
                            <?php if ($this->user->hasRights("Reviews", "delete")): ?>
                            ...
                            <?php endif; ?>
                            <?php if ($this->user->hasRights("Reviews", "edit")): ?>
