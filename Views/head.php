...
<body class="">
    ...
    <script src="<?=BASE_PATH?>/Views/Scripts/home_script.php"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/about_script.js"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/services_script.php"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/gallery_script.php"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/contact_script.php"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/book_script.js"></script>
    <script src="<?=BASE_PATH?>/Views/Scripts/account_script.php"></script>
