...
?>
      ...
      <main class="d-flex" id="account-Main">
          ...
          <h1>2FA</h1>
          <form action="<?=BASE_PATH?>/account/register-confirmation" method="POST">
            ...
            <div class="d-flex justify-content-center gap-4 my-5" style="width: 100%;">
                <input class="btn bttn-green  mt-3" role="button" type="submit" value="Create Account">
              <a class="btn btn-secondary mt-3" href="<?=BASE_PATH?>/account/register" role="button"><?= GO_BACK ?></a>
            </div>
          </form>
          </div>
      </main>
